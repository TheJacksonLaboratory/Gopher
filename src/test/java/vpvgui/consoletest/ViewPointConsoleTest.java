 ...
 * @author Peter Hansen
 */
public class ViewPointConsoleTest {
...
//        printViewPointSegments(testViewpointGATC, "GATC");
    ...
    @Test
    public void printViewpointPositionDistanceScore() throws FileNotFoundException {

        System.out.println("# distribution of scores generated by the function 'printViewpointPositionDistanceScore' in class 'ViewPointConsoleTest'");

        Integer maxDistToGenomicPos = 5000;

        System.out.print("dist<-c(");
        for(Integer dist = 0;dist<=maxDistToGenomicPos;dist++) {
            System.out.print(dist);
            if(dist<maxDistToGenomicPos) {
                System.out.print(",");
            }
        }
        System.out.print(")\n");

        System.out.print("distScore<-c(");
        for(Integer dist = 0;dist<=maxDistToGenomicPos;dist++) {
            double score = testViewpoint.getViewpointPositionDistanceScore(dist,maxDistToGenomicPos);
        ...
        System.out.println("cairo_pdf(\"position_distance_score.pdf\", height = 4, width = 8)");
        System.out.println("plot(dist, distScore, xlab=\"Distance to genomicPos\", ylab=\"Position distance score\", type=\"l\")");
