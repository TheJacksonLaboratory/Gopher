...
public class SegmentTest {
    ...
    private static Segment buildSegmentA(IndexedFastaSequenceFile reader) {
        Segment s = new Segment.Builder(referenceSequenceID,21,44).
                fastaReader(reader).
    ...
    private static Segment buildSegmentB(IndexedFastaSequenceFile reader) {
        Segment s = new Segment.Builder(referenceSequenceID,69,92).
                fastaReader(reader).
                marginSize(Default.MARGIN_SIZE).
                build();
        return s;
    ...
    private static Segment buildSegmentC(IndexedFastaSequenceFile reader) {
        Segment segment=new Segment.Builder(referenceSequenceID,93,112).
                fastaReader(reader).
