...
public class FASTAIndexManager extends Task<Void> {
    ...
    public FASTAIndexManager(String path, ProgressIndicator pi, Label label) {
    ...
    protected Void call() {
        ...
        logger.trace("Found "+n+" files in genome directory");
        ...
        this.statusLabel.setText("FASTA files indexed");
        return null;
    }
