...
public class JannovarGeneGenerator {
    /** Path to the serialized file generated by Jannovar. */
    ...
    /** Use Jannovar to find the String representation of chromosomes (which are represented as integers in the
     * TranscriptModel objects).
     */
    private void extractChromosomeNames() {
        this.chrId2Name = new HashMap<>();
    ...
    public Map<String,List<TranscriptModel>> checkGenes(List<String> genelst) {
        if (this.jannovarSerPath==null) {
            System.err.println("[ERROR] Path to serialized Jannovar file is not defined -- set it and retry!");
            return null;
        }
        if (genelst==null) {
